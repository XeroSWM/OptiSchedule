...
# --- SISTEMAS DE INFORMACIÓN (MALLA COMPLETA) ---
sistemas = [
    # Semestre 1
...
# --- DISEÑO INDUSTRIAL (MALLA COMPLETA) ---
diseno = [
    # Semestre 1
...
# --- CIVIL (MALLA COMPLETA CON TARGETS REPARTIDOS) ---
civil = [
    # SEM 1
    {"semestre": 1, "nombre": "Cálculo Diferencial", "horas": 6, "req_lab": "NO", "target": "Pitágoras"},
    {"semestre": 1, "nombre": "Dibujo CAD", "horas": 3, "req_lab": "SI", "target": "Construcción"}, # Arq. Construcción
    {"semestre": 1, "nombre": "Programación 1", "horas": 3, "req_lab": "SI", "target": "Sismología"}, # Le damos esto a otro para rellenar
    {"semestre": 1, "nombre": "Química Materiales", "horas": 3, "req_lab": "SI", "target": "Lavoisier"}, # Quimico del grupo fisico
    ...
    {"semestre": 2, "nombre": "Estática", "horas": 4, "req_lab": "NO", "target": "Resistencia"}, # Ing. Resistencia
    ...
    {"semestre": 3, "nombre": "Ensayo Materiales 1", "horas": 5, "req_lab": "SI", "target": "Suelos"}, # Ing. Suelos
    ...
    {"semestre": 5, "nombre": "Hormigón Armado 1", "horas": 6, "req_lab": "NO", "target": "Hormigones"}, # Ing. Hormigones
    ...
    {"semestre": 7, "nombre": "Estruc. Metálicas", "horas": 4, "req_lab": "NO", "target": "Puentes"}, # Msc. Puentes
    ...
    # SEM 8
    {"semestre": 8, "nombre": "Obras Civiles", "horas": 4, "req_lab": "NO", "target": "Gerencia"}, # Ing. Gerencia
    ...
    {"semestre": 8, "nombre": "Pavimentos", "horas": 4, "req_lab": "SI", "target": "Pavimentos"}, # Ing. Pavimentos
    ...
    {"semestre": 9, "nombre": "Plan Tesis", "horas": 2, "req_lab": "NO", "target": "Proyectos"}, # Ing. Proyectos
...
# ==========================================
# 2. NORMALIZADOR MATEMÁTICO (CORRECCIÓN DE HORAS)
# ==========================================
print("🔧 Normalizando horas impares para evitar conflictos de horario...")

for m in materias_raw:
    horas_originales = m['horas']
    
    # REGLA DE ORO: Todo a múltiplo de 2 (bloques de 2h)
    if horas_originales % 2 != 0:
        m['horas'] = horas_originales + 1
        
    # REGLA DE LABORATORIO PARA CIVIL:
    # Si pide Lab pero no es crítica, se lo quitamos para liberar presión.
    if m['carrera'] == "Civil" and m['req_lab'] == "SI":
        nombre = m['nombre'].lower()
        # Solo estas se quedan con Lab obligatorio
...
# ==========================================
# 3. LÓGICA DE ASIGNACIÓN (PISCINAS SEPARADAS)
# ==========================================
...
try:
    ...
    print("⚠️ Error leyendo ingenieros.xlsx. Asegúrate de ejecutar primero generar_ingenieros.py")
    ing_db = {}
...
for i, m in enumerate(materias_raw):
    ...
    if pool:
        ...
        # Fallback último recurso (Cualquiera de la carrera)
...
print("   - Se aplicó normalización de horas (Pares).")
print("   - Se segregaron los profesores de Básicas.")
print("   - Se asignaron los 14 especialistas nuevos de Civil.")